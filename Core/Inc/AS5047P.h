...
#if 0
#define CS_RESET_1 HAL_GPIO_WritePin(GPIOA, GPIO_PIN_11, GPIO_PIN_RESET)//left
#define CS_SET_1   HAL_GPIO_WritePin(GPIOA, GPIO_PIN_11, GPIO_PIN_SET)

#define CS_RESET_2 HAL_GPIO_WritePin(GPIOB, GPIO_PIN_9, GPIO_PIN_RESET)//right
#define CS_SET_2   HAL_GPIO_WritePin(GPIOB, GPIO_PIN_9, GPIO_PIN_SET)
#endif

#if 0
uint16_t as5047p_Transmit();
uint8_t ENC_init();
